    ...
    <Popover className="relative">
        ...
        >
            ...
            <div className="w-full lg:w-56 shrink rounded-xl bg-white p-4 text-sm font-semibold leading-6 text-gray-900 shadow-lg ring-1 ring-gray-900/5">
                ...
                <Link
                to='/profile'
                className='block p-2 hover:text-purple-950 hover:bg-gray-300 rounded-md'
                >Mi Perfil</Link>
                <Link
                to='/'
                className='block p-2 hover:text-purple-950 hover:bg-gray-300 rounded-md'
                >Mis Proyectos</Link>
                <button
                className='block p-2 hover:text-purple-950 text-start w-full hover:bg-gray-300 rounded-md'
                type='button'
                onClick={logout}
                >
                Cerrar Sesión
